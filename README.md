...
- [LinkedIn](https://www.linkedin.com/in/spencersmithsite)
- [GitHub](https://github.com/SpencerSmithSite)
- [X.com](https://x.com/spencersmthsite)

## 📄 License

This project is proprietary and available for viewing only. While the code is publicly visible for educational purposes, it may not be used, copied, modified, or distributed without explicit permission. See the [LICENSE](LICENSE) file for details. 
